    ...
    <div className="grid min-h-svh lg:grid-cols-2">
      <div className="flex flex-col gap-4 p-6 md:p-10">
        <div className="flex justify-center gap-2 md:self-end">
          <Link href="/register" className={`hidden lg:flex items-center gap-3  py-2.5 border font-medium text-sm border-gray-500 rounded-xl ml-4 relative overflow-hidden group transition-colors duration-500  hover:text-white `}>
