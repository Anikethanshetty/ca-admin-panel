...
const titles = [
    ...
    { path: "/history", w1: "Work", w2: "History" } 
];
        ...
        <nav ref={navRef} className="bg-white border-b dark:bg-gray-900 dark:border-gray-700 relative z-50">
            <div className="max-w-screen-xl flex items-center justify-between mx-auto p-4">
                ...
                <button 
                    ...
                    className="md:hidden p-2 text-gray-500 rounded-lg focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:focus:ring-gray-600"
                >
                    ...
                    <ul className="flex flex-col md:flex-row md:space-x-8 p-4 md:p-0 mt-4 border rounded-lg md:border-0 bg-gray-50 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900">
                        <li>
                            <Link 
                                ...
                                className={`block py-2 px-3 rounded-sm ${isActive('/home') ? 'text-primary' : 'text-gray-900 hover:text-primary dark:text-white'}`}
                            >
                                Home
                            </Link>
                        </li>
                        ...
                        <li className="relative">
                            <button 
                                ...
                                className={`flex items-center py-2 px-3 rounded-sm ${isDropdownOpen ? 'text-primary' : 'text-gray-900 hover:text-primary dark:text-white'}`}
                            >
                                Manage Employees
                            </button>
                            ...
                            {isDropdownOpen && (
                                <div className="absolute left-0 mt-2 w-44 bg-white rounded-lg shadow-lg dark:bg-gray-700">
                                    <ul className="py-2 text-sm text-gray-700 dark:text-gray-200">
                                        ...
                                        <li className="relative">
                                            <button 
                                                onClick={() => setIsAddEmployeesOpen(!isAddEmployeesOpen)} 
                        ...
                        <li>
                            <Link 
                                href="/message" 
                                onClick={() => setIsNavOpen(false)} 
                                className={`block py-2 px-3 rounded-sm ${isActive('/message') ? 'text-primary' : 'text-gray-900 hover:text-primary dark:text-white'}`}
                            >
                                Message
                            </Link>
                        </li>
